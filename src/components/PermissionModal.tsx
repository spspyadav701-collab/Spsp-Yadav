...
export function PermissionModal({ onClose }: Props) {
  return (
    <div id="permission-modal-overlay" className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-md p-4">
      <motion.div 
      ...
      >
        ...
        <p className="text-white/60 text-sm mb-6 leading-relaxed">
          Your browser has blocked microphone access for this site. Ai teacher cannot hear you until you allow it.
        </p>
